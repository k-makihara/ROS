...
(cl:defmethod cl:initialize-instance :after ((m <autodriverFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'autodriverFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actionlib_tutorials-msg:<autodriverFeedback> is deprecated: use actionlib_tutorials-msg:autodriverFeedback instead.")))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <autodriverFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actionlib_tutorials-msg:sample-val is deprecated.  Use actionlib_tutorials-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <autodriverFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader actionlib_tutorials-msg:data-val is deprecated.  Use actionlib_tutorials-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<autodriverFeedback>)))
  ...
  "actionlib_tutorials/autodriverFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'autodriverFeedback)))
  "Returns string type for a message object of type 'autodriverFeedback"
  "actionlib_tutorials/autodriverFeedback")
